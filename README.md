...
1. **Primary Channel (nRF24L01)** – Long-range transmission to the base station.  
2. **Error Detection & Resend Mechanism** – If data loss is detected, retransmission is triggered via an alternate route.  
...
2. Data is transmitted via the primary nRF24L01 channel.
